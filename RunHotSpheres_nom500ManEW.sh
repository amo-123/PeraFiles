...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/Week_2/20190313/PhantomWithSpheres/Correct_Spacer', 0, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/EW_PhantomWithSpheres.mat', 'nom500_manEW'"');exit;' \
2>&1 \
| tee ./RunHotSpheres_nom500ManEW_log
