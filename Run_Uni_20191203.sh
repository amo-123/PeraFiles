...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));UnkilledOneForAll('"'/SAN/inm/FDG/amoINSERT/LondonData/20191203/U/', 1, '/SAN/inm/FDG/amoINSERT/LondonData/20191203/U/' , '~', '_20191203_'"');exit;' \
2>&1 \
| tee ./Uni_20191203_log
