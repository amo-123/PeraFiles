...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/Week_2/20190313/ColdRodsPhantom', 0, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/ScatEW_ColdRods.mat', 'Scatter_'"');exit;' \
2>&1 \
| tee ./RunColdRods_Scatter
