...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/Week_2/20190313/CylinderPhantom', 0, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/EW_cylinder.mat', 'nom500_manEW'"');exit;' \
2>&1 \
| tee ./RunCylin_nom500ManEW_log
