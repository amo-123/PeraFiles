...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'"'.'"'"'));CallOneForAllScript('"'"''"/SAN/inm/FDG/amoINSERT/Week_2/20190313/PhantomWithSpheres/Correct_Spacer"''"'"');exit;' \
2>&1 \
| tee ./RunHotSphere_log
