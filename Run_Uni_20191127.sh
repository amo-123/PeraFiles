...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));UnkilledOneForAll('"'/SAN/inm/FDG/amoINSERT/LondonData/20191127/U/', 1, '/SAN/inm/FDG/amoINSERT/LondonData/20191127/U/' , '~', '_20191127_'"');exit;' \
2>&1 \
| tee ./Uni_20191127_log
