...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));UnkilledOneForAll('"'/SAN/inm/FDG/amoINSERT/LondonData/20190912/U/', 1, '/SAN/inm/FDG/amoINSERT/LondonData/20190912/U/' , '~', '_20190912_'"');exit;' \
2>&1 \
| tee ./Uni_20190912_log
