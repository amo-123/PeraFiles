function [ NodeData, AllData ] = OneForAll(filepath,filename,flagkill,uflag)
...
if uflag
    ...
    load('EnergyWindows/Cylinder_02_EW.mat','enwind');
end
...
output_savepath = strcat(pwd,'/Database_Reconstructions/Full_Rec_',filename(1:end-5),'.mat');
