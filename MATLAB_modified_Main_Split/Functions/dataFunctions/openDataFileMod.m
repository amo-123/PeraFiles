function [Data,nodeID,timestamp,modality] = openDataFileMod(File_Name,File_Path,chunk_events,ii)

disp(strcat('Loading .data File:',{' '},File_Path,File_Name));
...
file_pos = 0:2*(chunk_events*(8+channels)+4):FileSize;
