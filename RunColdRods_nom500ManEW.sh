...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/Week_2/20190313/ColdRodsPhantom', 0, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/EW_ColdRods.mat', 'nom500_manEW'"');exit;' \
2>&1 \
| tee ./RunColdRods_nom500ManEW_log
