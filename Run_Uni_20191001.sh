...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));UnkilledOneForAll('"'/SAN/inm/FDG/amoINSERT/LondonData/20191001/U/', 1, '/SAN/inm/FDG/amoINSERT/LondonData/20191001/U/' , '~', '_20191001_'"');exit;' \
2>&1 \
| tee ./Uni_20191001_log
