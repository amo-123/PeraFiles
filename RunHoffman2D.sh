...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'"'.'"'"'));CallOneForAllScript('"'"''"/SAN/inm/FDG/amoINSERT/Week_2/20190313/Hoffman2D"''"'"');exit;' \
2>&1 \
| tee ./RunHoffMan2D_newEW_log
