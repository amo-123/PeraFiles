...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'"'.'"'"'));CallOneForAllScript('"'"''"/SAN/inm/FDG/amoINSERT/Week_2/20190313/ColdRodsPhantom"''"'"');exit;' \
2>&1 \
| tee ./RunColdRodsNewEW_log
