...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/Week_2/20190313/Hoffman2D', 1, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/EW_Hoffman2D.mat', 'nom500_UEW'"');exit;' \
2>&1 \
| tee ./RunHoffman_nom500UEW_log
