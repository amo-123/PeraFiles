...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));UnkilledOneForAll('"'/SAN/inm/FDG/amoINSERT/LondonData/tmp/X/', 1, '/SAN/inm/FDG/amoINSERT/LondonData/tmp/U/' , '~', '_tmp_'"');exit;' \
2>&1 \
| tee ./LinX_tmp_log
