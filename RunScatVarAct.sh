...
matlab -nodisplay -nosplash -nodesktop -r 'addpath(genpath('"'.'"'));CallOneForAllScript('"'/SAN/inm/FDG/amoINSERT/LondonData/20191015/VariableActivityPhantom', 0, '/SAN/inm/FDG/amoINSERT/INSERT/PeraFiles/PeraFiles/EnergyWindows/ScatEW_cylinder.mat', 'London_Scatter_'"');exit;' \
2>&1 \
| tee ./RunVarAct_scatt_log
